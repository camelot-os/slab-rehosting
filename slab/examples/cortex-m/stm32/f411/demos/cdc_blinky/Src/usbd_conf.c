/**
  * USB Device BSP for STM32F411 (DWC2 OTG FS)
  *
  * PCD handle uses USB_OTG_FS instance (0x50000000).
  * Endpoint FIFOs are configured for CDC ACM operation.
  *
  * Based on STM32CubeF4 CDC_Standalone template.
...
USBD_StatusTypeDef USBD_LL_Init(USBD_HandleTypeDef *pdev)
{
  ...
  /* Configure RX/TX FIFOs for DWC2 OTG FS */

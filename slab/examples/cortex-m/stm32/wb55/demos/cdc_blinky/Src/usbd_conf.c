/**
  * USB Device BSP for STM32WB55 (native PMA-based USB FS)
  *
  * PCD handle uses USB instance (0x40006800), NOT DWC2 OTG.
...
USBD_StatusTypeDef USBD_LL_Init(USBD_HandleTypeDef *pdev)
{
  ...
  /* Enable USB power on PWR CR2 register */
  ...
  /* PMA endpoint buffer allocation */
